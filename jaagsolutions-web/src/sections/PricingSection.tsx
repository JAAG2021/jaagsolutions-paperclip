...
const plans = [
  {
    ...
    priceLabel: "Desde",
    period: "/ proyecto",
    priceNote: "Precio base · se ajusta según el alcance",
    highlight: false,
    ...
    features: [
      ...
      "Puedes contratar soporte continuo mes a mes después de la entrega",
  ...
  },
  {
    ...
    priceNote: "Precio orientativo · se define en el diagnóstico gratuito",
    highlight: true,
    ...
    features: [
      ...
      "Soporte 60 días + entregamos todo documentado para que tu equipo lo gestione solo",
      "Opción de mejoras y soporte continuo mes a mes al finalizar el proyecto",
  ...
  },
  {
    ...
    priceLabel: "",
    period: "",
    priceNote: "Lo definimos juntos en el diagnóstico gratuito",
    highlight: false,
